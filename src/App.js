        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mt-6">
          <div className="text-center">
            ...
            <div className="border-t border-gray-200 pt-4 mt-4">
              ...
              <p className="text-lg font-bold text-blue-600">Made by Arnav Chaurasia</p>
              <p className="text-sm text-gray-600 mb-2">EE- VLSI - 5th Semester</p>
          <p className="text-sm text-gray-600 mb-2">203</p>
